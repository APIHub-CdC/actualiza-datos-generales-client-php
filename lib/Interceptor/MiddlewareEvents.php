...
namespace ActualizaDatosGenerales\Client\Interceptor;
...
use \ActualizaDatosGenerales\Client\Interceptor\KeyHandler;
use \ActualizaDatosGenerales\Client\Interceptor\MyLogger;
use \ActualizaDatosGenerales\Client\Model\Errors;
use \ActualizaDatosGenerales\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\ActualizaDatosGenerales\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \ActualizaDatosGenerales\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \ActualizaDatosGenerales\Client\Model\Errores(["errors" => [$error]]);
